...
def bill_button_operation():
    ...
    if ans=="yes":
        ...
        st = "\t\t\t   Nameeth Multicusine Restaurant\n\t\tNo. 100 New Airport Road, Chagalatti, Bengaluru-562149\n"
        st += "\t\t\t GST NO:- 34VASFD2215HKAAA\n"
        st += "-"*61 + "BILL" + "-"*61 + "\nDate:- "
...
root.title("Nameeth Multicusine Restaurant")
...
title_label = Label(title_frame, text="Nameeth Multicusine Restaurant", 
